...
-- ----------------------------
-- Table structure for ctf_capture
-- ----------------------------
DROP TABLE IF EXISTS `ctf_capture`;
CREATE TABLE `ctf_capture`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `date_created` datetime(0) NULL DEFAULT NULL,
  `date_modified` datetime(0) NULL DEFAULT NULL,
  `name` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '赛事名称',
  PRIMARY KEY (`id`) USING BTREE,
...
VALUES (1, '2020-11-15 00:08:17', '2020-11-15 00:08:17', '超级管理员');
INSERT INTO `ocean`.`s_role`(`id`, `date_created`, `date_modified`, `name`)
VALUES (2, '2020-11-15 00:08:17', '2020-11-15 00:08:17', '运维管理员');
